...
public class PopularMovieFragment extends Fragment implements MovieItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rec_View= view.findViewById(R.id.rv_popular_movie);
        ...
        call.enqueue(new Callback<List<MovieResponse>>() {
            ...
            public void onResponse(Call<List<MovieResponse>> call, Response<List<MovieResponse>> response) {
                ...
                adapter=new Movie_adapter(getContext(), respons,PopularMovieFragment.this);
